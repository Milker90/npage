...
```
    class HomeViewModel extends ViewModel {
        ...
        // finally, when using pageviewhelper to create a MultiProvider, HomeViewModel and PageViewState 
        // will be added at the same time.
        // if want to change page state, call pageViewState.notifyPageState(state), 
        // pageViewState is in top node use Provider, so If HomeViewModel and PageViewState change at the same time，
